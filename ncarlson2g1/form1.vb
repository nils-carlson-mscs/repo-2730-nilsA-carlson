...
Public Class frmMain
    ...
    Private Sub btnCalc_Click(sender As Object, e As EventArgs) Handles btnCalcIf.Click
        ...
        If intQuantity > 15 AndAlso intQuantity <= 20 Then
            dblRate = 0.025
        End If
        If intQuantity > 20 AndAlso intQuantity <= 30 Then
            dblRate = 0.03
        End If
    ...
    Private Sub btnCalculateNested_Click(sender As Object, e As EventArgs) Handles btnCalculateNested.Click
        ' calculate discount and total due
    ...
    Private Sub btnCalcElseif_Click(sender As Object, e As EventArgs) Handles btnCalcElseif.Click
        'calculate elseif
